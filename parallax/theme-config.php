...
$themify_theme_config['panel']['settings']['tab']['theme_settings'] = array(
	...
	'custom-module' => array(
		...
		array(
			'title' => __('Gallery Slider Options', 'themify'),
		...
		array(
			'title' => __('Header Background Slider', 'themify'),
			'function' => 'themify_header_background_slider'
		),
		array(
			'title' => __('Parallax Scrolling Effect', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['section_title'] = array(
	'title' => __('Section Title', 'themify'),
	'id' => 'section_title',
	'element' => array(
		array(
			'title' => __('Section Title', 'themify'),
			'id' => 'section_title_styles',
			'selector' => '.section-post .section-title',
			'module' => array(
				'font-family',
				'color',
				'font-size',
		...
		array(
			'title' => __('Section Subheading', 'themify'),
			'id' => 'section_subheading',
			'selector' => '.section-post .section-subhead',
			'module' => array(
				'font-family',
				'color',
				'font-size',
