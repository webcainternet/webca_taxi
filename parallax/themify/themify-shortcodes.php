...
function themify_shortcodes_js_css() {
	...
	wp_enqueue_style( 'themify-shortcodes', THEMIFY_URI . '/css/shortcodes.css', array(), THEMIFY_VERSION);
		...
		case 'map':
			...
			return '<script type="text/javascript">	
						jQuery(document).ready(function() {
					  		initialize("'.$address.'", '.$num.', '.$zoom.', "'.$type.'");
						});
					</script>
...
/**
 * Flush transient when post saved
 * Twitter shortcode
 */
