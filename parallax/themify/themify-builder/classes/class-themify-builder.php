...
if ( ! class_exists( 'Themify_Builder' ) ) {
	...
	class Themify_Builder {
		...
		function load_module_partial_ajaxify() {
			...
			$this->get_template_module( $mod, $post_id, true, true, $w_class, $identifier );
		...
		function builder_admin_bar_menu( $wp_admin_bar ) {
			...
			if ( is_singular() || is_page() ) {
				$import_args = array(
					...
					'parent' => 'themify_builder',
					'title' => __('Import Builder Content', 'themify'),
					'href' => '#'
					),
						// Sub Menu
						array(
							...
							'title' => __('From Existing Pages', 'themify'),
							'href' => '#',
						...
						array(
							...
							'parent' => 'import_themify_builder',
							'title' => __('From Existing Posts', 'themify'),
							'href' => '#',
