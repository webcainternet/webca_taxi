...
foreach( $this->modules as $module_key => $module_settings ){
	$this->template_vars['module'][$module_key] = array(
		'content' => '<div class="themify_builder_module '.$module_key.' active_module" data-mod-name="'.$module_key.'">
						<div class="module_menu">
							<div class="menu_icon">
							</div>
							<ul class="themify_builder_dropdown" style="display:none;">
								<li><a href="#" class="themify_module_options" data-module-name="'.$module_key.'">'.__('Options', 'themify').'</a></li>
						...
						<div class="module_label">
							<strong class="module_name">'.$module_settings['name'].'</strong>
