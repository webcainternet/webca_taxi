...
/**
 * Cols detection html
 * It's related to js script to handle dynamic cols width detection
 */
?>

<div class="themify_builder_col_detection_4 themify_builder_row module_row clearfix" style="display: none;">
...
<div class="themify_builder_col_detection_3 themify_builder_row module_row clearfix" style="display:none;">
	...
	<div class="themify_builder_row_content">
		...
		<div class="themify_builder_col col3-1 first">
			<div class="themify_module_holder">
				<div class="empty_holder_text"><?php _e('drop module here', 'themify') ?></div><!-- /empty module text -->
			</div>
			<!-- /module_holder -->
		...
		<div class="themify_builder_col col3-1">
			<div class="themify_module_holder">
				<div class="empty_holder_text"><?php _e('drop module here', 'themify') ?></div><!-- /empty module text -->
			</div>
			<!-- /module_holder -->
		...
		<div class="themify_builder_col col3-1 last">
			<div class="themify_module_holder">
				<div class="empty_holder_text"><?php _e('drop module here', 'themify') ?></div><!-- /empty module text -->
			</div>
			<!-- /module_holder -->
...
<div class="themify_builder_col_detection_1 themify_builder_row module_row clearfix" style="display:none;">
	<div class="themify_builder_row_top">
		<div class="move_row"></div><!-- /move_row -->
		<div class="row_menu">
			<div class="menu_icon">
