...
<div id="<?php echo $module_ID; ?>" class="module themify_builder_slider_wrap <?php echo esc_attr( $class ); ?> clearfix">
	...
	<ul class="themify_builder_slider" 
		...
		<li style="<?php echo !empty($left_margin) ? 'margin-left:'.$left_margin.';' : ''; ?> <?php echo !empty($right_margin) ? 'margin-right:'.$right_margin.';' : ''; ?>">
			...
			<div class="slide-image">
				<?php
				$image_url = isset( $content['img_url_slider'] )? $content['img_url_slider'] : '';
