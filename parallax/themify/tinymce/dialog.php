...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="wp-admin" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
		...
		function themify_insert_shortcode(type) {
			...
			switch(type){
				case 'video':
					sc_content = '[' + type + ' ' + themify_scparams(['src', 'width', 'height'], type) + ']';
				break;
				
				case 'img':
					sc_content = '[' + type + ' ' + themify_scparams(['src', 'w', 'h'], type) + ']';
				break;
				
				case 'button':
					sc_content = '[' + type + ' ' + themify_scparams(['style', 'color', 'link', 'text', 'target'], type, true) + ']'
					+ jQuery('#label' + '_' + type).val() + '[/' + type + ']';
				break;
				
				case 'hr':
					sc_content = '[' + type + ' ' + themify_scparams(['color', 'width', 'border_width'], type) + ']';
				break;
				
				case 'box':
					sc_content = '[' + type + ' ' + themify_scparams(['style'], type, true) + ']' + selection + '[/' + type + ']';
				break;
				
				case 'map':
					sc_content = '[' + type + ' ' + themify_scparams(['address', 'width', 'height', 'zoom', 'type'], type) + ']';
				break;

				case 'author_box':
					sc_content = '[' + type + ' ' + themify_scparams(['avatar', 'avatar_size', 'style', 'author_link'], type) + ']';
				break;
				
				case 'flickr':
					sc_content = '[' + type + ' ' + themify_scparams(['user', 'set', 'group', 'limit', 'size', 'display'], type) + ']';
				break;
				
				case 'twitter':
					sc_content = '[' + type + ' ' + themify_scparams(['username', 'show_count', 'show_timestamp', 'show_follow', 'follow_text'], type) + ']';
				break;
				
				case 'post_slider':
					sc_content = '[' + type + ' ' + themify_scparams( ['limit', 'category', 'image', 'image_w', 'image_h', 'image_size', 'title', 'display', 'post_meta', 'more_text', 'visible', 'scroll', 'auto', 'wrap', 'speed', 'slider_nav', 'width', 'height', 'class', 'order', 'orderby'], type ) + ']';
				break;
				
				case 'list_posts':
					sc_content = '[' + type + ' ' + themify_scparams(['limit', 'category', 'image', 'image_w', 'image_h', 'post_meta', 'more_text', 'post_date', 'style', 'image_size', 'order', 'orderby'], type) + ']';
				break;
				
				case 'slider':
					sc_content = '[' + type + ' ' + themify_scparams(['visible', 'scroll', 'auto', 'wrap', 'speed', 'slider_nav', 'class'], type, true) + ']' + selection + '[/' + type + ']';
				break;
			}
